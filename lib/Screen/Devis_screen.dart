...
class DevisScreen extends StatefulWidget {
  ...
  const DevisScreen({Key key, this.animationController, this.animation})
      : super(key: key);

  @override
  _DevisScreenState createState() => _DevisScreenState();
}
                                          ...
                                          children: <Widget>[
                                            DataTable(
                                              columns: [
                                                ...
                                                DataColumn(label: Text('Fiche Devis',style: style(),)),
                                              ],
