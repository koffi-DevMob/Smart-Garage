...
class VehiculeScreen extends StatefulWidget {
  ...
  const VehiculeScreen({Key key, this.animationController, this.animation})
      : super(key: key);

  @override
  _VehiculeScreentState createState() =>_VehiculeScreentState();
}

class _VehiculeScreentState extends State<VehiculeScreen> {
  ...
  affiche() async {
    ...
    final String session_cookie = sharedPreferences.getString('session_cookie');
    var headers = {
      'Cookie': ''
    };
                                            ...
                                            children: <Widget>[
                                              DataTable(
                                                columns: [
                                                  ...
                                                  DataColumn(label: Text('Véhicule',style: style(),)),
                                                  DataColumn(label: Text('Fiche Réception',style: style(),)),
                                                ],
                                                rows: model?.map((clients) {
                                                  return DataRow(
                                                      cells: [
                                                        DataCell(Text("${clients['date_reception']}",style: style1(),)),
                                                        DataCell(Text("${clients['marque']} | ${clients['immatriculation']}",style: style1(),)),
